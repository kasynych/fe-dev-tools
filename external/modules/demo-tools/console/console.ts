...
import { IOptions, options } from 'external/modules/demo-tools/demo'
...
export default class Console {
  ...
  static handleDemoOptionsChanged(event?: CustomEvent<Partial<IOptions>>) {
    if (!Console.initialized && !event?.detail?.renderConsole) {
      return
    }
    Console.refresh()
  }
