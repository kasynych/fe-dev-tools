...
export class StepAdjustmentDialog {
  static area: HTMLElement = null;
  static similarElements: HTMLElement[] = [];
  static currentElementIndex: number |null = null;
  static stepIndex: number = null;
  static step: DemoStep = null;

  static open(step: DemoStep, index: number) {
    ...
    StepAdjustmentDialog.similarElements = Dom.getSelector(StepAdjustmentDialog.step) ?
      Array.from(document.querySelectorAll(Dom.getSelector(StepAdjustmentDialog.step))).filter((e: any) => e.checkVisibility()) as HTMLElement[] :
      []
        ...
        actions: [
          {
            label: 'Ok',
            action: () => {
              DemoTools.demo?.adjustStepElement(StepAdjustmentDialog.stepIndex, e)
            }
          },
          {
            label: 'Adjust',
            action: () => {
              DemoTools.demo?.updateStep(StepAdjustmentDialog.stepIndex, Dom.getElementXPath(e as HTMLElement))
            }
          }
        ]
      }))
  ...
  static render(highlightEl?: Element) {
    ...
    DemoTools.demo.driver.highlight({
      ...
      popover: {
        ...
        onPopoverRender: () => {
          ...
          autoAdjustButton?.addEventListener('click', StepAdjustmentDialog.handleAutoAdjustClick)
          editButton?.addEventListener('click', StepAdjustmentDialog.handleEditClick)
          prevButton?.addEventListener('click', StepAdjustmentDialog.handlePrevClick)
          nextButton?.addEventListener('click', StepAdjustmentDialog.handleNextClick)
          checkAllButton?.addEventListener('click', StepAdjustmentDialog.handleCheckAllClick)
        }
      },
      onDestroyed: () => {
        autoAdjustButton?.removeEventListener('click', StepAdjustmentDialog.handleAutoAdjustClick)
        editButton?.removeEventListener('click', StepAdjustmentDialog.handleEditClick)
        prevButton?.removeEventListener('click', StepAdjustmentDialog.handlePrevClick)
        nextButton?.removeEventListener('click', StepAdjustmentDialog.handleNextClick)
        checkAllButton?.removeEventListener('click', StepAdjustmentDialog.handleCheckAllClick)
      }
    })
  }
  ...
  static handleAutoAdjustClick() {
    DemoTools.demo.driver.destroy();
    DemoTools.demo?.adjustStepElement(StepAdjustmentDialog.stepIndex, StepAdjustmentDialog.similarElements[StepAdjustmentDialog.currentElementIndex]);
    Highlighter.destroy();
  }

  static handleEditClick() {
    DemoTools.demo.driver.destroy();
    DemoTools.demo?.updateStep(StepAdjustmentDialog.stepIndex, DemoTools.demo.dom.getElementXPath(StepAdjustmentDialog.similarElements[StepAdjustmentDialog.currentElementIndex]));
    Highlighter.destroy();
  }
